...
public class HyundaiCar implements ICar {
	...
	public void turnOn() throws InterruptedException {
		System.out.println("LenovoTablet - 시동이 부드럽게 잘 걸린다~H");
		Thread.sleep((long)(Math.random()*500) + 500);
	}

	@Override
	public void turnOff() throws InterruptedException {
		System.out.println("LenovoTablet - 시동이 부드럽게 잘 Off~H");
		Thread.sleep((long)(Math.random()*500) + 500);
	}

	@Override
	public void accel() throws InterruptedException {
		System.out.println("LenovoTablet - 엑셀이 터보로 동작된다~H");
		Thread.sleep((long)(Math.random()*500) + 500);
	}

	@Override
	public void footBreak() throws InterruptedException {
		System.out.println("LenovoTablet - 브레이크가 부드럽게 동작된다~H");
		Thread.sleep((long)(Math.random()*500) + 500);
	}
