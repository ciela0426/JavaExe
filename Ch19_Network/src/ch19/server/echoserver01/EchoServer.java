...
public class EchoServer {
	public static void main(String[] args) {
		...
		try {
			...
			// Client와 직접 통신(서비스)하는 소켓 객체 리턴
			// Client와 연결과정(스트림 형성 과정)이 완료되면 리턴
			...
			/*
			 * Low Level통신에서는 위의 socket을 통해 직접 통신하지만 우리는 좀 더 편리한 통신을 위해 필터 클래스를 사용하겠다
			 */
			...
			while (true) {
				...
				if (line == null)
					break; // ine == null -> 통신이 끊어졌다(상대방이 종료함)
